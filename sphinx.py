...
class SphinxModel:
    ...
    def generate_model(self):
        ...
        with tf.device(self.cpu):
            ...
            #     tf.summary.scalar('point_error', self.point_dists, collections=['train', 'test'])
            #     tf.summary.scalar('label_error', self.correct_label, collections=['train', 'test'])
    ...
    def _train(self, nEpochs=10, epoch_size=1000, save_step=500, valid_iter=10):
        with tf.name_scope('Train'):
            ...
            print('  Relative Improvement - Point: ' + str((self.resume['point_error'][0] - self.resume['point_error'][-1]) * 100) + '%')
