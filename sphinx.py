...
class SphinxModel:
    ...
    def generate_model(self):
        ...
        with tf.name_scope('inputs'):
            ...
            self.gt_map = tf.placeholder(tf.float32, (None, self.nStacks, self.hm_size, self.hm_size, self.num_points))
    ...
    def _train(self, data_gen):
        ...
        for epoch in range(self.nEpochs):
            ...
            # Validation Set
            point_error = self._valid(data_gen[1])
    ...
    def _define_saver_summary(self):
        if self.logdir_train is None:
            ...
            self.valid_summary = tf.summary.FileWriter(self.logdir_train)
